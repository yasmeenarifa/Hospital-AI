...
import { HeartPulse, Search, Filter, MessageSquare, Users, BarChart3, Calendar } from "lucide-react"
import { PatientFeedbackList } from "@/components/patient-feedback-list"
      ...
      <header className="sticky top-0 z-10 bg-white border-b border-slate-200 shadow-sm">
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/crm" className="text-sm font-medium text-slate-900 hover:text-purple-600 transition-colors">
              CRM
            </Link>
          </nav>
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-slate-500 mt-1">Manage patient interactions and improve satisfaction</p>
              </div>
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="relative flex-1">
                      ...
                      <Input type="search" placeholder="Search patients or appointments..." className="pl-8 bg-white" />
                    </div>
